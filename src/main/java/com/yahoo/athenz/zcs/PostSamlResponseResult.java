...
public final class PostSamlResponseResult {
    private ResourceContext context;
    private int code; //normal result

    PostSamlResponseResult(ResourceContext context) {
    ...
    public void done(int code, String string, String location) {
        Response resp = Response.status(code).entity(string)
